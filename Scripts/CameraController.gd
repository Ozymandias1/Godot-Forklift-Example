...
var camera_local_pos: Vector3

# 시작
func _ready():
	Input.mouse_mode = Input.MOUSE_MODE_CAPTURED
	camera_local_pos = camera_3d.position
...
func _process(delta):
	...
	camera_3d.position = lerp(camera_3d.position, camera_local_pos, 5.0 * delta)
